document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.getElementById('celulares-list')) {
        ...
        function populateBrandFilter() {
            ...
            const currentFilter = document.getElementById('filterDropdown').dataset.currentFilter || 'all'; // Default a 'all'
            document.getElementById('filterDropdown').textContent = `Filtrar por Marca: ${currentFilter === 'all' ? 'Todos' : currentFilter}`;
        ...
        loadCelulares('all'); // Carga inicial con 'all' para que muestre todos si no se filtra nada.
    }
